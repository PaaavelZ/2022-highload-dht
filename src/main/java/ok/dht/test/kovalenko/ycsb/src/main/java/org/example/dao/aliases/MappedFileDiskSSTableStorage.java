...
import org.example.dao.dto.FileMeta;
...
public class MappedFileDiskSSTableStorage
    ...
    private void updateTables(long numFilesOnDisk) throws ReflectiveOperationException, IOException {
        long numFilePairs = numFilesOnDisk / 2;
        if (this.get(numFilePairs) == null) {
            mapForRead(numFilePairs, serializer);
        }
    }
}
